...
class HotelActivity : AppCompatActivity(), HotelListFragment.OnHotelClickListener, SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener {
    ...
    companion object {
        const val EXTRA_SEARCH_TERM = "lastSearc"
    }
}
